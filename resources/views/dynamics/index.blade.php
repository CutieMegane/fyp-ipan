...
@section('content')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var fieldHTML = '<div><input type="text" name="col1" value=""/><a href="javascript:void(0);" class="remove_button"><img src="{{ asset('img/remove-icon.png') }}" width="20" height="20"/></a></div>'; //New input field html 
